...
LOCK TABLES `home_count` WRITE;
/*!40000 ALTER TABLE `home_count` DISABLE KEYS */;
INSERT INTO `home_count` VALUES (1,'Free Consultations',2500,'Case Success Rate',96,'Professional Experience',20,'Expert Attorneys',40,'2026-03-03 14:33:15','2026-03-03 14:35:28');
/*!40000 ALTER TABLE `home_count` ENABLE KEYS */;
UNLOCK TABLES;
