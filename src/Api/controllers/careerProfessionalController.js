...
exports.getAllCareerProfessionals = async (req, res) => {
 ...
 try {
    ...
    res.status(200).json({ message: "Career Professionals fetched successfully",
...
res.status(200).json({ message: "Career Professional updated successfully", data: careerProfessionalToUpdate });
...
try {   
    ...
    res.status(200).json({ message: "Career Professional deleted successfully" });  
