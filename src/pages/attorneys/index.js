...
export default function AttorneysPage() {
  ...
  const getLanguages = async () => {
    try {
      ...
      console.log("ALL Languages", response);
  ...
  return (
    <main className="bg-white overflow-hidden">
          ...
          <div className="col-lg-5 p-4 p-md-5">
            ...
            <div className="d-flex gap-4">
              <div className="form-check">
                <input
                  className="form-check-input border-dark bg-dark"
                  type="radio"
                  name="stype"
                  defaultChecked
                  id="name"
              ...
              <div className="form-check">
                <input
                  ...
                  id="keyword"
                />
                <label className="form-check-label fw-bold" htmlFor="keyword">
                  Search By Keyword
                </label>
              </div>
            </div>
              ...
              <div className="d-flex flex-wrap gap-x-4 gap-y-2">
                {filters.map((item) => (
                  <button
                    ...
                    {item}
                    <i
                      className={`bi bi-chevron-${activeFilter === item ? "down" : "right"} ms-2 fs-6 opacity-75`}></i>
                  </button>
                ))}
              </div>
            </div>
      ...
      {/* Conditional rendering for Languages */}
      {activeFilter && (
        <section className="container mt-5">
          <div className="p-1" style={{ border: `1px solid ${gtGold}` }}>
            <select className="form-select border-0 shadow-none fs-5 py-2 rounded-0 bg-light">
              ...
              {/* Check if the current active filter is "Language" */}
              {activeFilter === "Language" ? (
                ...
                /* Fallback for other filters like Location, Education, etc. */
                <>
      ...
      <section className="container mb-5 shadow p-0 overflow-hidden">
        <div className="row g-0">
          <div
            className="col-md-4 p-5 text-center text-white"
            style={{ backgroundColor: gtBlue }}>
