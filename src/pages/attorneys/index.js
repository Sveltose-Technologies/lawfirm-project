...
//                 <p className="text-uppercase text-white small mb-0 fw-bold tracking-wider">
//                   Search Criteria:
//                 </p>
//                 <p className="text-gold mb-0 fw-bold fs-5">
//                   {selectedLetter || searchQuery || filterValue || "All"}{" "}
//                   <span
...
//                 </p>
//               </div>
//               <div className="col-md-4 text-md-end text-white">
//                 <p className="text-uppercase small mb-0 fw-bold tracking-wider">
//                   Sort By:
//                 </p>
...
//                       {/* Middle: Name, Role, Email, Phone */}
//                       <div className="col-md-7 ps-md-4">
//                         <Link
//                           href={`/attorneys/${attorneySlug}`}
//                           className="text-decoration-none">
//                           <h2 className="text-gold font-serif display-6 mb-1 pointer-link">
//                             {attr.firstName} {attr.lastName}
//                           </h2>
//                         </Link>
//                         <p className="text-white text-uppercase small fw-bold mb-2 tracking-widest opacity-75">
//                           {attr.servicesOffered || "ASSOCIATE"}
//                         </p>
//                         <a
//                           href={`mailto:${attr.email}`}
//                           className="text-blue text-decoration-none d-block mb-1 fs-5">
//                           {attr.email}
//                         </a>
//                         <p className="text-blue mb-0 fs-5">{attr.phoneCell}</p>
//                       </div>

//                       {/* Right: City (Top) and Category Box (Bottom) */}
//                       <div className="col-md-3 d-flex flex-column justify-content-between text-md-end">
//                         <Link
//                             href={`/location/${createSlug(cityObj.cityName)}`}
//                           className="text-decoration-none">
//                           <span className="text-blue small pointer-link fw-bold">
...
//                             className="text-decoration-none">
//                             <div className="d-inline-block border border-white p-2 px-4 text-white text-uppercase fw-bold small tracking-wider pointer-box hover-effect">
...
//                 <button
//                   className="btn btn-outline-gold px-5 py-2 text-uppercase fw-bold"
...
//     // ALL FILTERS LOGIC (Capability, Location, Admission, Education, Language)
//     const matchesDropdown =
//       !filterValue ||
...
//                     }`}
//                     onClick={() => {
//                       setActiveFilter(f); // Set the active category
//                       setFilterValue(""); // Reset dropdown value on new category click
//                     }}>
//                     <span>{f}</span>
//                     <i
...
//               {/* Dropdown: ONLY visible when activeFilter is NOT null */}
//               {activeFilter && (
//                 <div
...
//   /* appearance: 'auto' ko hata diya gaya hai */
//   value={filterValue}
//   onChange={(e) => setFilterValue(e.target.value)}
// >
//   <option value="">Select {activeFilter}</option>
//   {/* options ka logic wahi rahega... */}
//   {activeFilter === "Capability" && categories.map((c) => (
...
//                   {/* Reset Option (Optional: To hide dropdown again) */}
//                   <button
...
//       {/* 4. RESULTS LIST */}
//       {(selectedLetter || searchQuery || filterValue) && (
//         <section className="py-5" style={{ backgroundColor: "#222" }}>
//           <div className="container">
...
//               </div>
//               <div className="col-md-4 text-md-center">
//                 <p className="text-uppercase text-white small mb-0 fw-bold tracking-wider opacity-75">
//                   Search Criteria:
//                 </p>
...
//               </div>
//               <div className="col-md-4 text-md-end text-white">
//                 <p className="text-uppercase small mb-0 fw-bold tracking-wider opacity-75">
//                   Sort By:
//                 </p>
//                 <p className="mb-0 small">
//                   Position |{" "}
...
//                       {/* Middle: Name, Role, Email, Phone */}
//                       <div className="col-md-6 col-lg-7 d-flex flex-column justify-content-center ps-md-4 py-2">
//                         <Link
//                           href={`/attorneys/${attorneySlug}`}
//                           className="text-decoration-none">
//                           <h2 className="text-gold font-serif display-6 fw-bold mb-1 pointer-link">
//                             {attr.firstName} {attr.lastName}
//                           </h2>
//                         </Link>
...
//                           {attr.email}
//                         </a>
//                         <p className="text-blue mb-0 fs-5">
//                           {attr.phoneCell || "+1 000.000.0000"}
//                         </p>
//                       </div>

//                       {/* Right: City (Top) and Category Box (Bottom) */}
//                       <div className="col-md-3 d-flex flex-column justify-content-between text-md-end py-2">
//                         <div>
//                           <Link
//                             href={`/location/${createSlug(cityObj?.cityName || "")}`}
//                             className="text-decoration-none">
...
//                             href={`/capability/${createSlug(catObj?.categoryName || "")}`}
//                             className="text-decoration-none">
//                             <div className="d-inline-block border border-white p-2 px-3 text-white text-uppercase fw-bold small tracking-wider pointer-box hover-effect">
//                               {catObj?.categoryName || "Expertise"}
//                             </div>
//                           </Link>
//                         </div>
