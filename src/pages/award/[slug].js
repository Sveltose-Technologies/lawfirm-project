...
//           <button
//             onClick={() => router.push("/award")}
//             className="btn btn-sm btn-back-list mb-4 px-3">
//             &larr; BACK TO LIST
//           </button>
//           <h1 className="display-4 fw-bold">{award.awardTitle}</h1>
//           <p className="lead">
...
//           {/* Left Column: Details */}
//           <div className="col-lg-8">
//             <div className="bg-white p-4 p-md-5 shadow-sm border-navy-top">
//               <h3 className="fw-bold mb-4 border-bottom pb-2">
//                 Award Overview
//               </h3>
//               <div
//                 className="text-dark fs-5 award-details-text"
//                 dangerouslySetInnerHTML={{ __html: award.details }}
//               />
//             </div>
//           </div>
...
//             <div className="card border-0 shadow-sm">
//               <div className="card-body p-4">
//                 <h5 className="fw-bold mb-4 text-uppercase small border-bottom pb-2 text-muted">
//                   Information
//                 </h5>
...
//                     YEAR
//                   </label>
//                   <p className="year-display mb-0">{award.year}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
    ...
    <div className="bg-light-gray min-vh-100">
      ...
      <div className="container py-5">
        <div className="row g-4">
          {/* Left Column: Details */}
          <div className="col-lg-8">
            {/* Added 'overflow-hidden' and dynamic-wrap class */}
            <div className="bg-white p-4 p-md-5 shadow-sm border-navy-top h-100 overflow-hidden">
              <h3 className="fw-bold mb-4 border-bottom pb-2">
                Award Overview
              </h3>
              <div
                className="text-dark fs-5 award-details-text dynamic-wrap"
                dangerouslySetInnerHTML={{ __html: award.details }}
              />
            </div>
          </div>
            ...
            <div
              ...
              <div className="card-body p-4">
                ...
                <div className="mb-4">
                  ...
                  <p className="fw-bold mb-0 text-navy fs-5">
                    {award.personName}
                  </p>
                </div>
      ...
      <style jsx global>{`
        /* Isse content right side mein nahi jayega */
        .dynamic-wrap {
          width: 100% !important;
        ...
        /* Editor se aane wali badi headings ko chhota aur wrap karne ke liye */
        .dynamic-wrap h1,
        .dynamic-wrap h2,
        .dynamic-wrap h3 {
          max-width: 100% !important;
