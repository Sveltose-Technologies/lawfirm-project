...
// import { getAllHomeBanners, getImgUrl } from "../../services/authService";
// function Header() {
...
//   useEffect(() => {
//     setMounted(true); // Component load hone par true karein

//     getAllHomeBanners()
//       .then((res) => {
//         const banners = res.data?.data || [];

//         // LOGIC: Woh image dhundho jiska typeId 1 hai (Logo)
//         // Aur jisme textEditor khali hai (kyuki logo mein text nahi hota)
//         const logoData = banners.find(
//           (b) =>
//             Number(b.typeId) === 1 &&
//             (!b.textEditor || b.textEditor === "<p></p>"),
//         );
...
//                 {/* Agar database mein logo hai to wo dikhao, nahi to fallback local logo */}
//                 <img
//                   src={
//                     logoUrl
//                       ? getImgUrl(logoUrl)
...
//                     </li>
//                     <li>
//                       <button className="dropdown-item">Telugu (తెలుగు)</button>
//                     </li>
//                     <li>
//                       <button className="dropdown-item">Tamil (தமிழ்)</button>
//                     </li>
//                     <li>
//                       <button className="dropdown-item">Marathi (मराठी)</button>
//                     </li>
//                     <li>
...
//                     </li>
//                     <li>
//                       <button className="dropdown-item">Urdu (اردو)</button>
//                     </li>
//                     <li>
//                       <button className="dropdown-item">
//                         Punjabi (ਪੰਜਾਬੀ)
